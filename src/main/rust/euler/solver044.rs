...
use crate::algorithm::long::{is_pentagonal, pentagonal};
use crate::Solver;

/// Pentagonal numbers are generated by the formula, `P(n) = n * (3 * n − 1) / 2`. The first ten pentagonal numbers are: `1, 5, 12, 22, 35, 51, 70, 92, 117, 145, ...`
///
...
impl Solver for Solver044 {
    fn problem_name(&self) -> &str { "Pentagon numbers" }
